// generated-from:daaa28468096aee259d7e97639b372312eec780337a6a337198df14fb211f140 DO NOT REMOVE, DO UPDATE
...
func NewEnvironment(env *Environment) (*Environment, error) {
	...
	if env.Consumer == nil {
		c, err := NewConsumer(env.Logger, env.Config.Consumer)
		if err != nil {
			return nil, err
		}
		env.Consumer = c
